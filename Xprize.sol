...
/**
    ...
    * Email: support@xprize.io
    Three token features:
    5% fee auto add to the liquidity pool to locked forever when selling
    3% fee auto distribute to all holders (Lower overall penality for buying / selling should resolve cross exchange 
...
contract XPRIZE is Context, IERC20, Ownable {
    ...
    string private _name = "XPRIZE";
    string private _symbol = "XPRIZE";
